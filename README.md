...
Для цього ми написали такі основні функції:
	...
	write_graph(path, graph, directed) - Симко Олександра
	find_connected_components(graph, start) - Юрга Юлія
	find_strongly_connected_components(graph, vertex) - Сагайдак Юрій
...
write_graph(path, graph, directed)
